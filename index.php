...
$sql = "SELECT Job_ID,Job_CreateDate,Job_Type,Job_Project,Job_Assign,Job_Subject,Job_Progres,Job_StartDate,Job_FinishDate,Job_Priority,Job_CreateUser FROM job ";
if ($stmt = $mysqli->prepare($sql)) {
  // $stmt->bind_param('s', $value);  // สำหรับ Where
  $stmt->execute();
  $stmt->store_result(); 
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">ระบบบันทึกรายละเอียดการทำงานของพนักงาน Test</a>
  ...
  <div class="container">
    <h1 class="text-center my-2">รายละเอียดการทำงานของพนักงาน</h1>
